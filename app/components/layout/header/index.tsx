...
const Header = () => {
  ...
  return (
    <header id="header" className="sticky top-[0px] z-[99]">
      <div id="header-brand" className="header-brand bg-blue content-14 text-center py-[8px]  ">
        Exclusive Offer: Use code <strong>PRESS20</strong> for <strong> 20% off</strong> your order
      </div>
      <div className="header-wrapper border-b border-black bg-white ">
        <div className="container mx-[auto]">
          <div className="flex items-center py-[12px] justify-between">
            <div className="logo">
              <Image src={Logo} alt="Logo" className="min-w-[120px]" />
            </div>
            <Button variant={'default'} className='uppercase px-6'>Shop now</Button>
          </div>
        </div>
      </div>
    </header>
